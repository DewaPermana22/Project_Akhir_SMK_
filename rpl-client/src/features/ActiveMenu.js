  ...
  Guru: [
    ...
    },
    {
      ...
      children: [
        ...
        { key: "penugasan-guru", text: "Penugasan", icon: "BookCheck", type: "item" },
        { key: "ujian-guru", text: "Ujian", icon: "ClipboardPenLine", type: "item" },
        ...
        { key: "pengumuman-guru", text: "Pengumuman", icon: "Megaphone", type: "item" },
      ],
    },
  ],
